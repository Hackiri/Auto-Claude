...
describe('useProfileSwapNotifications', () => {
  beforeEach(() => {
    ...
    (window as unknown as { electronAPI: unknown }).electronAPI = {
      queue: {
        onQueueProfileSwapped: mockOnQueueProfileSwapped.mockReturnValue(() => { /* no-op */ }),
        onQueueBlockedNoProfiles: mockOnQueueBlockedNoProfiles.mockReturnValue(() => { /* no-op */ }),
        onQueueSessionCaptured: mockOnQueueSessionCaptured.mockReturnValue(() => { /* no-op */ })
      }
    };
  });
